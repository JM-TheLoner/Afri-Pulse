    ...
    <div> 
      <DataProvider>
        ...
        <Routes>
          ...
          <Route exact path='/register/personal' element={<Register/>}></Route>
          <Route exact path='/register/contact' element={<Contactinfo/>}></Route>
          <Route exact path='/register/user' element={<Userinfo/>}></Route>
